      ...
      <section className="py-12 bg-primary">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/80">
            Upload your medical documents for secure storage and consultation
          </p>
        </div>
      </section>
                ...
                {step === 1 && (
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Please provide your medical records for upload
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-gold/10 border border-gold/30 rounded-lg p-4">
                          ...
                          <p className="text-xs text-muted-foreground mt-2">
                            Your documents will be securely stored and
                    ...
                    <CardContent>
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                        <p className="text-sm text-blue-900">
                          ...
                          limitations and scope of the service.
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent className="text-center space-y-6">
                      ...
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <p className="text-sm text-blue-900">
                          Your documents have been securely uploaded and stored.
                          You can access and share them with doctors during
                          consultations.
                        </p>
                      </div>
